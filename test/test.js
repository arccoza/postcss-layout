...
// 	t.equal(css, tests["grid"].out);
// 	// console.log(css);

// 	lazy = processor.process(tests['grid undefined'].in);
// 	css = null;

// 	t.throws(function() { css = lazy.css; }, tests['grid undefined'].out);
// });

// test('span property; use grid span', function(t) {
// 	t.plan(2);
// 	var lazy = processor.process(tests['grid span'].in);
// 	var css = lazy.css;

// 	t.equal(css, tests["grid span"].out);
// 	// console.log(css);

// 	lazy = processor.process(tests['grid span undefined'].in);
// 	css = null;

// 	t.throws(function() { css = lazy.css; }, tests['grid span undefined'].out);
// });